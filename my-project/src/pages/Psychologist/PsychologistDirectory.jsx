...
//             </div>
//           </div>
//           <p className="mt-4 text-gray-600 font-medium text-sm sm:text-base">Loading psychologists...</p>
//         </div>
//       </div>
//     );
//   }
...
//             </div>
//             <h2 className="text-red-800 font-bold text-lg sm:text-xl mb-1 sm:mb-2">Connection Error</h2>
...
//           <Shield className="h-5 w-5 sm:h-8 sm:w-8 mr-2 text-blue-600" />
...
//             {filteredPsychologists.length} professional{filteredPsychologists.length !== 1 ? 's' : ''}
//           </span>
//         </div>
//       </div>
...
//             </div>
//             <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-1 sm:mb-2">No psychologists found</h3>
//             <p className="text-gray-500 mb-4 sm:mb-6 max-w-md mx-auto text-xs sm:text-sm">
//               {searchTerm ? 'Try adjusting your search terms or clear the search to see all professionals.' : 'There are no psychologists in the directory yet.'}
//             </p>
//             {searchTerm && (
//               <button
...
//               <div key={psychologist.id} className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100">
...
//                       <span className="text-xl sm:text-2xl">{getGenderIcon(psychologist.gender)}</span>
//                     </div>
//                     <div>
...
//                       <h4 className="text-xs sm:text-sm font-semibold text-gray-900">Languages</h4>
//                     </div>
...
//                         <h4 className="text-xs sm:text-sm font-semibold text-gray-900">Specializations</h4>
//                       </div>
//                       <div className="flex flex-wrap gap-1 sm:gap-2">
//                         {psychologist.specializations.split(',').map((spec, i) => (
//                           <span key={i} className="text-xs bg-green-100 text-green-800 px-2 py-0.5 sm:px-3 sm:py-1 rounded-full font-medium break-words">
//                             {spec.trim()}
//                           </span>
//                         ))}
//                       </div>
